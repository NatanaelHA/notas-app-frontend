...
export default function GithubLink({ className = '' }: GithubLinkProps) {
  return (
    <a
      href='https://github.com/NatanaelHA/notas-app-frontend'
      target='_blank'
      rel='noopener noreferrer'
      className={`flex items-center gap-1.5 text-sm text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-100 transition-colors ${className}`}
    >
